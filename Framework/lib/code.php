...
class code
{
    private $width=280,$height=38,$codenum=4;
...
//尝试开始session
    ...
    */
    ...
    private function createImage()
    {
        ...
        $back = imagecolorallocate($this->checkimage,222,222,225);
        //$border = imagecolorallocate($this->checkimage,12,22,150);
        imagefilledrectangle($this->checkimage,0,0,$this->width - 1,$this->height - 1,$back); // 白色底
        imagerectangle($this->checkimage,0,0,$this->width - 1,$this->height - 1,'');   // 黑色边框
    }
    /**
     * 设置图片的干扰像素
     */
